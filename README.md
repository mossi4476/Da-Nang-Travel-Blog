...
A multi-page website built using `HTML` and `CSS` skills which includes custom images, layout, and styling. Along with the webpage design considerations, I worked to appropriately structure the files, as well as use proper formatting & style. The project also focuses on using Flexbox and Grid systems to make the page responsive.

Open and view the Project using the `.zip` file provided or at my [Github Repository](https://github.com/mossi4476/Da-Nang-Travel-Blog).

The project is also hosted on [Github Pages](https://mossi4476.github.io/Da-Nang-Travel-Blog).
...
For details on how everything has been implemented, refer to the source code.
